...
async function getManifest() {
  try {
    // useCache: false — the manifest must be read-after-write consistent,
    // otherwise a write right after a previous write can read a stale copy
    // and clobber it (e.g. deleting a photo "un-deletes" others on refresh).
